            ...
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`font-inter font-medium transition-all hover:opacity-80 rounded-full text-[14px] md:text-[16px] snap-start whitespace-nowrap px-5 py-2 md:py-2.5 border border-solid ${
                    active 

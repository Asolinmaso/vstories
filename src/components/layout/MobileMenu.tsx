            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed top-0 left-0 h-full w-[300px] max-w-[85vw] bg-[var(--background)] z-50 shadow-2xl flex flex-col"
                    >
                        {/* Header */}
                        <div className="flex items-center justify-between p-6 border-b border-[var(--primary)]/10 flex-shrink-0">
                            <span

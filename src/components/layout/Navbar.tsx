            ...
            >
                <div className="w-full px-[100px]">
                    <nav className="flex items-center">
                        ...
                        {/* Center - Navigation Links (Width: 424px) */}
                                ...
                                >
                                    <Link
                                        ...
                                        className={`flex items-center gap-1.5 text-[16px] leading-[19px] transition-all duration-300 font-inter ${
                                            link.label === "Home" ? "font-semibold text-black" : "font-normal text-black hover:text-[var(--primary)]"
                                        }`}
                                    >
                                        {link.label}
                                        {link.dropdown && (
                                            <svg className={`w-3 h-3 transition-transform duration-300 ${activeDropdown === link.label ? 'rotate-180' : ''}`} viewBox="0 0 12 6" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M1 1L6 5L11 1" /></svg>
                                        )}
                                    </Link>
                        ...
                        {/* Right Section (Width: 356px) */}
                        <div className="hidden lg:flex items-center gap-[32px] w-[356px] justify-end">
                            {/* Search Bar */}
                            <form onSubmit={handleSearch} className="relative">
                                <div className="flex items-center gap-3 px-4 py-[12px] rounded-lg border border-black bg-transparent w-[229px] h-[40px]">
                                    ...
                                    <input
                                        ...
                                        className="bg-transparent text-[16px] leading-[24px] focus:outline-none w-full font-poppins placeholder:text-black/60"
                                    />
                                </div>
                            </form>
                            ...
                            {user ? (
                                ...
                                <button
                                    ...
                                    className="flex items-center justify-center w-[95px] h-[43px] rounded-lg text-[16px] leading-[19px] font-medium bg-[#1D3B29] text-[#F7EDE2] hover:bg-[#2A4F38] transition-all font-inter"
                                >
                                    Log In
                                </button>
                            )}
